 ...
 //This code is partially borrowed from http://www.holytrinityorthodox.com/ru/calendar/v2staff/loadCalendar_v2.js
...
if ( (current_date >= cristmass_lent_begin) && (current_date < cristmass_lent_nicolos) ) {
	if ( (current_day_of_week == 0) || (current_day_of_week == 2) ||
		 (current_day_of_week == 4) || (current_day_of_week == 6) ) {fasting_level = level5}
	if (current_day_of_week == 1) {fasting_level = level3}
	...
	if ( (current_date.valueOf() == cristmass_lent_theotocos.valueOf()) && ((current_day_of_week == 3) ||
		 (current_day_of_week == 5)) ) {fasting_level = level5;}
}
...
if ( ((current_date >= cristmass_lent_nicolos) && (current_date <= end_of_current_year)) ||
	...
	if ( (current_day_of_week == 0) || (current_day_of_week == 6) ) {fasting_level = level5}
	if (current_day_of_week == 1) {fasting_level = level3}
	if ( (current_day_of_week == 3) || (current_day_of_week == 5) ) {fasting_level = level2}
	if ( (current_day_of_week == 2) || (current_day_of_week == 4) ) {fasting_level = level4}
}
...
if ( (current_date >= beg) && (current_date < beg_pharesee) || (current_date >= end_pharesee) &&
	...
	if ( (current_day_of_week == 3) || (current_day_of_week == 5) ) {fasting_level = level5}
}
...
if ( (current_date >= beg_meet_free_week) && (current_date <= end_meet_free_week) ) {fasting_level = level7}
...
if ( (current_date >= uspensky_lent_begin) && (current_date < uspensky_lent_end) ) {
	...
	if ( (current_day_of_week == 1) || (current_day_of_week == 3) || (current_day_of_week == 5) ) {fasting_level = level2}
	if ( (current_day_of_week == 2) || (current_day_of_week == 4) ) {fasting_level = level3}
	if ( current_date.valueOf() == transfiguration.valueOf() ) {fasting_level = level5;}
...
if ( (current_date > palm_sunday) && (current_date < great_lent_end) && (current_day_of_week == 6) ) {fasting_level = level2;}
...
if ( (current_date.valueOf() == sochelnik_cr.valueOf()) || (current_date.valueOf() == sochelnik.valueOf()) ||
	 (current_date.valueOf() == beheading.valueOf()) || (current_date.valueOf() == elevation.valueOf()) ) {fasting_level = level4}
...
if ( (current_date >= sviatki_begin) && (current_date <= sviatki_end) ) {fasting_level = level8}
...
if ( ((current_date >= paresee_begin)   && (current_date <  paresee_end)) || 
	 ((current_date >  pentecost_begin) && (current_date <= pentecost_end)) ) {fasting_level = level8}
...
if(fasting_level)
	return [fast_name,fasting_level];
...
return false;
 ...
 function highlightDays(date) {
		...
		var dates12 = new Array();
		var tips12 = new Array();
		...
		var datesgreat = new Array();
		var tipsgreat = new Array();
		...
		for (var i = 0; i < dates12.length; i++) {
            if (+dates12[i] == +date) {
                return [true, 'highlight-12', tips12[i]];
            }
        }		
